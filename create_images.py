...
eqpath = noise_sig_path # select path to data chunk

img_save_path = 'images/big_data_random/waves/'
...
starts = list(np.linspace(data_start,data_end-data_interval,(data_end-data_start)/data_interval))
ends = list(np.linspace(data_interval,data_end,(data_end-data_start)/data_interval)))
set = str(chunk_name)
